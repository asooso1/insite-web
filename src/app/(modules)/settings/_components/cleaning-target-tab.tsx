...
import {
  useCleaningTargetList,
  useAddCleaningTarget,
  useUpdateCleaningTarget,
...
export function CleaningTargetTab() {
  const { data: tree, isLoading } = useCleaningTargetList();
  const addMutation = useAddCleaningTarget();
  const updateMutation = useUpdateCleaningTarget();
  ...
  return (
    <div className="space-y-4">
          ...
          <CardContent className="pt-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium">대상명</label>
                  <Input
                    value={formData.name}
                    onChange={(e) =>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">미화 대상 목록</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left px-4 py-2 font-medium">대상명</th>
