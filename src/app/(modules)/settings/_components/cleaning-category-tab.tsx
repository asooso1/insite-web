...
import {
  useCleaningCategoryList,
  useAddCleaningCategory,
  useUpdateCleaningCategory,
...
export function CleaningCategoryTab() {
  const { data: tree, isLoading } = useCleaningCategoryList();
  const addMutation = useAddCleaningCategory();
  const updateMutation = useUpdateCleaningCategory();
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">미화 분류 목록</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left px-4 py-2 font-medium">분류명</th>
