...
import { useWeeklyReport } from "@/lib/hooks/use-reports";
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <InfoPanel
        ...
        items={[
          ...
          { label: "시작일", value: report.workDateFrom },
          { label: "종료일", value: report.workDateTo },
